...
if(length(args)!=4){
  stop("Faltan argumentos: spark-submit LinearSupportVectorMachine.R appName master dataset outputFile")
}
...
model <- spark.svmLinear(training,  ~ features, regParam = 0.01, maxIter = 10)
